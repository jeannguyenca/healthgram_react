              ...
              <Card className="widthcard">
                ...
                <CardBody>
                  ...
                  <Form>
                    ...
                    <FormGroup row>
                      <Label for="phone" className="text-right" sm={3}>
                        Phone
                      </Label>
                      <Col sm={9}>
                        <Input
                    ...
                    <FormGroup row>
                      <Label for="date_of_birth" className="text-right" sm={3}>
                        Birthday
                      </Label>
                      <Col sm={9}>
                        <Input
                    ...
                    <FormGroup row>
                      <Label className="text-right" for="city" sm={3}>
                        City
                      </Label>
                      <Col sm={9}>
                        <Input
                    ...
                    <FormGroup row>
                      <Label className="text-right" for="country" sm={3}>
                        Country
                      </Label>
                      <Col sm={9}>
                        <Input
